...
class Bot(Client):
    ...
    async def start(self):
        try:
            ...
            self.LOGGER(__name__).info(
                "Bot Berhenti. Gabung Channel https://t.me/ZeldaProjects untuk Bantuan"
            )
            sys.exit()
        ...
        self.LOGGER(__name__).info(
            f"[🔥 BERHASIL DIAKTIFKAN! 🔥]\n\nBOT Dibuat oleh @RedflixHD\nJika Membutuhkan Bantuan, Silahkan Tanyakan di Channel https://t.me/ZeldaProjects"
        )
